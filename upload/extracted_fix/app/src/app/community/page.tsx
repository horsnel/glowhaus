...
import { Search, ThumbsUp, Plus, TrendingUp, Clock, Users, Flag } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <a href="/" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#E11D48] to-[#F43F5E] flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-white" />
              </div>
              <span className="font-bold text-xl text-[var(--text-primary)]">Community</span>
            </a>
            <a
              href="/app"
